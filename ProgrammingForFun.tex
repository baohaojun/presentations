...
\begin{frame}[fragile,label={sec:orgf97c34b}]{SICP\thinspace 介绍（Structure and Interpretation of Computer Programs）}
 \begin{block}{一个小目标？}
\pause
\end{block}
...
\begin{frame}[label={sec:orgccdb30b}]{Get Things Done\thinspace 工作方法}
\pause
\begin{itemize}[<+->]
