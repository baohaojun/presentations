...
\begin{frame}[fragile,label={sec:orgfb97c0a}]{SICP\thinspace 介绍（Structure and Interpretation of Computer Programs）}
 \begin{block}{一个小目标？\text{\includegraphics[width=1em,valign=t,raise=0.1em,natwidth=48bp,natheight=48bp]{/home/bhj/src/github/Wrench/release/emojis/new-emojis/ali-29-HeiHei.png}}}
\pause
\end{block}
