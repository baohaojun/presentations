...
- 项目已过时，需要修改源码之后才能运行
    ...
    # #+begin_src diff
    #   From 17f2c79482e7626de1d094ed9812e70f51d8e85e Mon Sep 17 00:00:00 2001
    #   From: Bao Haojun <baohaojun@lixiang.com>
    #   Date: Mon, 8 Mar 2021 15:28:48 +0800
    #   Subject: [PATCH] Fix build error for fel4
    ...
    #   index ed3b09c..0ee0318 100644
    #   --- a/src/generator.rs
    #   +++ b/src/generator.rs
    #   @@ -42,6 +42,7 @@ impl<'a, 'b, 'c, W: Write> Generator<'a, 'b, 'c, W> {
    ...
    #    use core::mem;
    #    use sel4_sys::*;\n\n",
    #   @@ -105,7 +106,6 @@ static mut CHILD_STACK: *const [u64; CHILD_STACK_SIZE] =
    ...
    #   @@ -257,7 +257,7 @@ fn lang_start<T: Termination + 'static>(
    ...
    #   @@ -309,7 +309,7 @@ pub fn eh_personality() {
